...
/* Define username and associated password array */$logins = array('admin' => 'admin','username1' => 'password1','username2' => 'password2');
...
$msg="<span style='color:red'>Trời ơi cái quần què gì đây ba. Thôi xuống đi ba phim chiếu rồi! Nhập sai thông tin rồi!</span>";
$suggest="<span style='color:red'>Tài khoản: admin | Mật khẩu: admin</span>";
}
}
?>
...
<body>
  ...
  <div class="login-container">
    ...
    <form action="" method="post" name="Login_Form" class="form login">
      <?php if(isset($msg)){?>
      <p class="label" style="text-align: center" ><?php echo $msg;?></p>
      <p class="label" style="text-align: center" ><?php echo $suggest;?></p>
    <?php } ?>
      <div class="form__field form__field--email">
        <label class="label label--icon" for="login__email">
          ...
          <span class="hidden">Tài khoản</span>
        </label>
        <div class="form__input-wrapper">
          <input id="login__email" type="text" name="Username" class="form__input" placeholder="Tài khoản" required>
          <!--
      ...
      <div class="form__field form__field--password">
        <label class="label label--icon" for="login__password">
          ...
          <span class="hidden">Mật khẩu</span>
        </label>
        <div class="form__input-wrapper">
          <input id="login__password" type="password" name="Password" class="form__input" placeholder="Mật khẩu" required>
          <!--
              FF is ignoring position relative of form__input-wrapper so added a wrapper for .underline.
              NOTE: just the precense of this comment fixes this FF issue (making the underline-wrapper unncessary).
              But I'd rather not rely on a comment.
